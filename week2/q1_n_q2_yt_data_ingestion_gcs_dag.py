...
dataset_url_template = dataset_url_prefix + '/yellow_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.csv'
...
with DAG(
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        task_id="yt_bigquery_external_table_task",
        table_resource={
            "tableReference": {
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> delete_files_task
